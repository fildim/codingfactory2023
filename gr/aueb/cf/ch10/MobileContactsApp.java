...
public class MobileContactsApp {
    ...
    static int pivot = -1;      //δειχνει παντα στο τελευταιο του πινακα
    ...
    public static void  printMenu() {
        ...
        System.out.println("5. Εκτύπωση όλων");
    ...
    */
    ...
    public static boolean insert(String firstname, String lastname, String phoneNumber) {
        ...
        if (getIndexByPhoneNumber(phoneNumber) != -1) return false;     //υπαρχει ηδη
    ...
    public static String[] delete(String phoneNumber) {
        ...
        System.arraycopy(contacts[positionToDelete], 0, contact, 0, contact.length);        //κραταμε τη παλια εγγραφη

        if ( !(positionToDelete == contacts.length - 1)) {      //αν δεν ειμαστε στη τελευταια εγγραφη
